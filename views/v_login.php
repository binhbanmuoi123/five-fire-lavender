<div class="container-default">
        ...
        <aside>
            ...
            <!-- Link quay lại -->
            <a href="?mod=user&act=forgot" class="back-link"><strong style="font-size: 14px; margin-right: 10px;"><a href="quenmatkhau.html" style="text-decoration: none; font-size: 12px; font-weight: 200; color: black;">Quên mật khẩu ?</a><strong style="font-size: 12px; font-weight: 100; color: #939090;"> hoặc </strong>
