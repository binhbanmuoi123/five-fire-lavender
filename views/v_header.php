...
<div class="login">
    ...
    <p>
        ...
        if (isset($_SESSION['user']['name'])) {
            echo "Chào bạn, " . htmlspecialchars($_SESSION['user']['name']) . "!"; // Hiển thị tên người dùng
            echo '<br><a href="?mod=user&act=logout">Đăng xuất</a>'; // Link đăng xuất
        } else {
            echo '<a href="?mod=user&act=login">Đăng nhập / Đăng ký<br>Tài khoản của tôi</a>';
        }
        ?>
    </p>
</div>
                    ...
                    <p><a href="?mod=cart&act=cart">giỏ hàng</a></p></div>
            </div>
        </div>
